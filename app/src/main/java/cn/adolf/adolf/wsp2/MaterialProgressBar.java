...
public class MaterialProgressBar extends ProgressBar {
    ...
    public MaterialProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            int backgroundDrawable = ta.getResourceId(R.styleable.MaterialProgressBar_backgroundColour, R.drawable.clip_progress_bg);
            int progressDrawable = ta.getResourceId(R.styleable.MaterialProgressBar_progressColour, R.drawable.shape_progress_bg);
            ...
            Log.d("progress: ", "backgroundColour: " + backgroundColour + ", progressColour: " + progressColour +
                    ", backgroundDrawable: " + backgroundDrawable + ", progressDrawable: " + progressDrawable);
        } finally {
            ta.recycle();
        }
        ...
        // setProgressDrawable(resources.getDrawable(R.drawable.shape_progress_bg));
    ...
    private void createIndeterminateProgressDrawable(@ColorInt int backgroundColour, @ColorInt int progressColour) {
        ...
        if (layerDrawable != null) {
            ...
            // 第二进度为真实显示的绿色，第一进度设置为和背景一样，完成覆盖第二进度
            layerDrawable.setDrawableByLayerId(android.R.id.progress, this.getResources().getDrawable(R.drawable.clip_progress_bg));
            layerDrawable.setDrawableByLayerId(android.R.id.background, this.getResources().getDrawable(R.drawable.shape_progress_bg));
            layerDrawable.setDrawableByLayerId(android.R.id.secondaryProgress, this.getResources().getDrawable(R.drawable.clip_progress_color));

        }
    }

    private Drawable createClipDrawable(@ColorInt int colour) {
        // Drawable shapeDrawable = this.getResources().getDrawable(R.drawable.shape_progress_color);
    ...
    private ShapeDrawable createShapeDrawable(@ColorInt int colour) {
        // ShapeDrawable shapeDrawable = (ShapeDrawable) this.getResources().getDrawable(R.drawable.shape_progress_bg);
